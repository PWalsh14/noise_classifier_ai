const glossary = [
  ...
  },
  {
    ...
    definition: "A measure of how certain a model is about its prediction, typically shown as a percentage."
  },
  {
    key: "confusionmatrix",
  ...
  },
  {
    key: "feature",
    display: "Feature",
    definition: "A measurable piece of information or pattern extracted from data that a model uses to make decisions."
  },
  {
  ...
  },
  {
    key: "melscale",
    display: "Mel Scale",
    definition: "A frequency scale based on how humans perceive pitch. It's used in audio processing to better reflect human hearing sensitivity, especially at lower frequencies."
  },
  {
    key: "melspectrogram",
  ...
  },
  {
    ...
    definition: "The structure and arrangement of layers in a neural network model, including convolutional, pooling, and fully connected layers."
  },
  {
    key: "modelevaluation",
  ...
  },
  {
    key: "overfitting",
    display: "Overfitting",
    definition: "A modeling error that occurs when a model learns noise or details from training data that don't generalize to new data."
  },
  {
    key: "padding",
    display: "Padding",
  ...
  },
  {
    key: "training",
    display: "Training",
    definition: "The process of teaching a model to make predictions by feeding it labeled examples. Over multiple epochs, the model learns patterns that help it make accurate predictions on new data."
  },
  {
    key: "traintestsplit",
  ...
  },
  {
    key: "waveform",
    display: "Waveform",
    definition: "A visual representation of an audio signal that shows changes in amplitude (volume) over time."
  }
];
